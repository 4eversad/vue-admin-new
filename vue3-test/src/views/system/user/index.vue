      ...
      <el-col :lg="4" :xs="24" class="mb-[12px]">
        <el-card shadow="never">
          <el-input v-model="searchDeptName" placeholder="部门名称" clearable>
            <template #prefix><i-ep-search></i-ep-search> </template>
          </el-input>
          <el-tree
            ref="deptTreeRef"
            class="mt-2"
          ...
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item>
              <el-button type="primary" @click="handleQuery"
                ><i-ep-search></i-ep-search>搜索
              </el-button>
              <el-button @click="resetQuery"
                ><i-ep-refresh></i-ep-refresh>重置
              </el-button>
            </el-form-item>
          </el-form>
        </div>
...
import { UserForm, UserQuery, UserPageVO } from "../../../api/user/type";
